package com.gj.android.commonlibrary.adapter;
...
public abstract class CommonHeaderRecyclerAdapter<T> extends RecyclerView.Adapter{

    protected static final String TAG = CommonHeaderRecyclerAdapter.class.getSimpleName();
    ...
    public CommonHeaderRecyclerAdapter(Context context, List<T> list, int layoutId) {
...
//    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, final int position) {
        ...
        CommonHeaderRecyclerAdapterHelper helper = new CommonHeaderRecyclerAdapterHelper(mContext,mHolder,layoutId,position);
    ...
    public abstract void convert(CommonHeaderRecyclerAdapterHelper helper, T t); //抽象方法，外部实现 目的是为item布局组件元素设置显示的数据
