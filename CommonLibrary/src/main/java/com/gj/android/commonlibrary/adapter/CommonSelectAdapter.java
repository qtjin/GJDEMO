...
public abstract class CommonSelectAdapter<T> extends BaseAdapter {
    ...
    protected static final String TAG = CommonSelectAdapter.class.getSimpleName();

    protected final Context mContext;
    private final int layoutId;
    protected List<T> mList;

    private Map<Integer,Boolean> isSelectMap; //某item是否被选中 Integer代表item的position

    public Map<Integer,Boolean> getSelectMap(){
        return isSelectMap;
    }

    public CommonSelectAdapter(Context context, int layoutId) {
        this.mContext = context;
        this.layoutId = layoutId;
        this.mList = new ArrayList<>();
    }

    public CommonSelectAdapter(Context context, List<T> list, int layoutId) {
        this.mContext = context;
        this.layoutId = layoutId;
        if (list == null) {
            this.mList = new ArrayList<>();
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        convert(helper, getItem(position),isSelectMap);
        return helper.getConvertView();
    }

    public abstract void convert(CommonAdapterHelper helper, T t,Map<Integer,Boolean> isSelectMap);
