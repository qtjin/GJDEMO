...
public interface Api {
   ...
   Observable<BaseBean<DoctorListBean.DataBean>> getDoctorList(@Field("seqType") String seqType, @Field("curPage") String curPage
           , @Field("drType") String drType, @Field("SearchStr") String SearchStr, @Field("sectionsName") String sectionsName);
