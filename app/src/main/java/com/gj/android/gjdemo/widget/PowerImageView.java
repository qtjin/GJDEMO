...
import com.gj.gjlibrary.util.AbDensityUtils;
...
public class PowerImageView extends ImageView implements OnClickListener {
	...
	public PowerImageView(Context context, AttributeSet attrs, int defStyle) {
		...
		mImageWidth = AbDensityUtils.dip2px(context,a.getDimension(R.styleable.PowerImageView_layout_width, 15f));
		mImageHeight =AbDensityUtils.dip2px(context,a.getDimension(R.styleable.PowerImageView_layout_height, 15f));
		AbLog.i("mImageWidth:"+mImageWidth);
		AbLog.i("mImageHeight:"+mImageHeight);
