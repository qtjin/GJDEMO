...
public class LoadMoreRecyclerView extends RecyclerView {
    ...
    private LinearLayout ll_foot_loading;
    ...
    public class AutoLoadAdapter extends Adapter<ViewHolder> {
        ...
        public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            if (viewType == TYPE_HEADER) {
                ...
                headerViewCallback.getHeaderView(mHeaderView); //把创建好的headerView回调给Activity
        ...
        public void addHeaderView(int resId,HeaderViewCallback headerViewCallback) {
            mHeaderResId = resId;
...
//        super.swapAdapter(mAutoLoadAdapter, true);
     ...
     */
    public void addHeaderView(int resId,HeaderViewCallback headerViewCallback) {
        mAutoLoadAdapter.addHeaderView(resId,headerViewCallback);
    }
    ...
    public void setResultSize(int resultSize) {
        if(resultSize == pageSize){ //如果返回的实际记录数等于约定的记录数，视其为还有更多数据
            notifyMore(true);
        }else{
            notifyMore(false);
        }
     ...
     *
     * @param hasMore ture 还有 false没有
     */
    public void notifyMore(boolean hasMore) {
